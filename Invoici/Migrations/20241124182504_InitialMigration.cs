    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 11, 24, 23, 55, 2, 704, DateTimeKind.Local).AddTicks(2979), "Office Supplies Purchase", "27AABCU9603R1ZV", "ABC Corporation" },
                    { "2", new DateTime(2024, 11, 24, 23, 55, 2, 704, DateTimeKind.Local).AddTicks(3924), "IT Services Billing", "27AAECS1223M1ZV", "XYZ Industries" },
                    { "3", new DateTime(2024, 11, 24, 23, 55, 2, 704, DateTimeKind.Local).AddTicks(3927), "Raw Materials Invoice", "27AAGCS1223R1ZV", "LMN Traders" }
                });
